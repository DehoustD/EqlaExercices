...
public class c3e7calculette2 {
    ...
    public static void main(String[] args) {
        ...
        ShowAllStuff(scanResult1,scanResult2);
    }

    static void ShowAllStuff(float _nbr1,float _nbr2){
        System.out.println("addition = " + _nbr1 + " + " + _nbr2 + " = " + NumberAddition(_nbr1, _nbr2) +
            "\nmultiplication = " + NumberMult(_nbr1, _nbr2) +
