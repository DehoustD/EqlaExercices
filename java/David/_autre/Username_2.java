...
public class Username_2 {
    ...
    static Scanner input = new Scanner(System.in);
     ...
     public static void main(String[] args) {
        ...
        userName = ChooseName(userName);
        boatName = ChooseName(boatName);

        System.out.println(userName + " prend la mer seul sur son bateau, le " + boatName + ", une grande aventure l'attend !");
    }

    static String ChooseName(String name){

        String _defaultName = name;
    ...
    static String ConfirmName(String _userName){
        ...
        if(choice.equals("o")){
            ...
            _userName = ChooseName(_userName);
        }else{
